...
## Project Structure
    ...
    ├── talent_everywhere_30874  # Django project configurations
...
1. Clone this repo and `cd talent_everywhere_30874`
...
2. Clone this repo and `cd talent_everywhere_30874`
